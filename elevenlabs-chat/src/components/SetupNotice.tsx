    ...
    <div className="grid min-h-full place-items-center px-6">
      <div className="w-full max-w-md">
        ...
        <p className="mt-2 text-[15px] leading-relaxed text-neutral-600">
          ...
          <span className="font-medium text-neutral-900">Public</span>, then copy its ID into a
          file called <code className="rounded bg-neutral-100 px-1.5 py-0.5">.env.local</code> in
          the project root:
        </p>
